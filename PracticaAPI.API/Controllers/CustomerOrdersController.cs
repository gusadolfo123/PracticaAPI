...
{    
    ...
    public class CustomerOrdersController : Controller
    {
        ...
        {
            return Mapper.Map<IEnumerable<CustomerOrderDTO>>(_context.CustomerOrders.OrderByDescending(x => x.Date));
        }
        ...
        {
            return Mapper.Map<IEnumerable<CustomerOrderDTO>>(_context.CustomerOrders
        ...
        public async Task<IActionResult> GetCustomerOrder([FromRoute] int id)
        {
            ...
            var customerOrder = await _context.CustomerOrders.SingleOrDefaultAsync(m => m.Id == id);
